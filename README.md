...
`Weng, X., Ling, K. V., Liu, H., Wang B., & Cao K. (2026). NeRC: Neural Ranging Correction through Differentiable Moving Horizon Location Estimation. In Proceedings of the 2026 ACM/IEEE International Conference on Embedded Artificial Intelligence and Sensing Systems (pp. 903-917).`
