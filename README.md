...
`Weng, X., Ling, K. V., Liu, H., Wang B., & Cao K. (2025). NeRC: Neural Ranging Correction through Differentiable Moving Horizon Location Estimation. In Proceedings of the 2026 ACM/IEEE International Conference on Embedded Artificial Intelligence and Sensing Systems (pp. 903-917).`
<!--- Badge for paper link---> <a href="https://dl.acm.org/doi/full/10.1145/3774906.3800475"><img src="https://img.shields.io/badge/ACM/IEEE%20SenSys '26-paper-green"/></a>
